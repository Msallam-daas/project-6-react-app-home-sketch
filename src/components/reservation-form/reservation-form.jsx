  ...
  return (
    <div className="reservation-form-container">
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label>Start Time, please choose a time after 8:00 AM</label>
          <input
            name="startTime"
            type="time"
        ...
        <div>
          <label>Finish Time, please choose a time before 4:00 PM</label>
          <input
            name="finishTime"
            type="time"
        ...
        <button type="submit" className="bookExerciseBtn">
          Book
        </button>
      </form>
    </div>
